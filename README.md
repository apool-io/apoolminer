...
### 3.4.4
1. CPU performance improved by 80%-100%.
### 3.4.5
1. CPU performance improved by 100%.
2. GPU performance improved by 20%-30%.
### 3.4.6
...
1. Qubic epoch 207.
### 3.6.1
1. GPU performance increased by up to 50%.
2. CPU performance increased by up to 60%-100%.
